...
//  Demo_HytradingHome
//
//  Created by 肖鑫 on 2018/4/20.
//  Copyright © 2018年 肖鑫. All rights reserved.
//
...
//
//        self.photoBlock(image, fileUrl);
        
        NSData *imgData = UIImagePNGRepresentation(image);
        
        NSArray *documents = NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES);
        
        NSString *path = [documents.firstObject stringByAppendingString:@"/face.png"];
        
        [imgData writeToFile:path atomically:YES];
        
        self.photoBlock(image, [NSURL URLWithString:path]);
    }
}
